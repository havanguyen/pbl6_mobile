...
import '../../../model/services/remote/staff_service.dart';
import '../../../view_model/location_work_management/snackbar_service.dart';

class DeleteStaffConfirmationDialog extends StatefulWidget {
  final Map<String, dynamic> staff;
  final VoidCallback onDeleteSuccess;
  final SnackbarService snackbarService;
  final String role;

  const DeleteStaffConfirmationDialog({
    super.key,
    required this.staff,
  ...
  @override
  State<DeleteStaffConfirmationDialog> createState() =>
      _DeleteStaffConfirmationDialogState();
}

class _DeleteStaffConfirmationDialogState
    extends State<DeleteStaffConfirmationDialog> {
  ...
  Future<void> _confirmDelete() async {
    ...
    try {
      final success = await StaffService.deleteStaff(
        widget.staff['id'],
        password: password,
      );
      ...
      if (mounted) {
        ...
        if (success) {
          ...
          widget.snackbarService.showSuccess(
            '${AppLocalizations.of(context).translate('delete_success')} ${widget.role.toLowerCase()}',
          );
        } else {
          setState(() {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          Text(
            '${AppLocalizations.of(context).translate('confirm_delete_staff_message')}${widget.role.toLowerCase()}: ${widget.staff['fullName']}?',
            style: TextStyle(color: context.theme.popoverForeground),
          ),
