    ...
    if (mounted) {
      ...
      if (success) {
        ...
        widget.snackbarService.showSuccess(
          AppLocalizations.of(context).translate('delete_info_section_success'),
        );
      } else {
        setState(() {
          _apiErrorMessage = AppLocalizations.of(
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          Text(
            '${AppLocalizations.of(context).translate('confirm_delete_info_section_message')}: ${widget.infoSection.name}?',
            style: TextStyle(color: context.theme.popoverForeground),
          ),
