...
class DeleteStaffConfirmationDialog extends StatefulWidget {
  ...
  @override
  State<DeleteStaffConfirmationDialog> createState() => _DeleteStaffConfirmationDialogState();
}

class _DeleteStaffConfirmationDialogState extends State<DeleteStaffConfirmationDialog> {
    ...
    try {
      ...
      if (mounted) {
        ...
        if (success) {
          ...
          widget.snackbarService.showSuccess('Xóa ${widget.role.toLowerCase()} thành công!');
        } else {
          setState(() {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          Text(
            'Bạn có chắc chắn muốn xóa ${widget.role.toLowerCase()}: ${widget.staff['fullName']}?',
            style: TextStyle(color: context.theme.popoverForeground),
          ),
